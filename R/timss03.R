...
#' for grade 8 mathematics (2003)
#'
#' This is data from the United States sample of the 2003 TIMSS assessment for
#' grade 8 mathematics. This data contains responses to 23 items from 757
#' respondents. This data has been used by Skaggs et al. (2016) and Su et al.
#' (2013) to evaluate the appropriateness of using diagnostic models for
#' modeling the TIMSS assessment data.
...
#' * `algebraic_expressions`: Apply and extend understandings of arithmetic to
...
#' * `use_proportional_relationships`: Use proportional relationships to solve
...
#' * `compare_fractions`: Compare two fractions with different numerators and
#'   denominators.
#' * `multistep_problems`: Solve multi-step problems with whole numbers using
#'   the four operations.
#' * `equivalent_fractions`: Use equivalent fraction as a strategy to add and
#'   subtract fractions.
#'
#' For more details, see Table 2 of Su et al. (2013).
#'
#' @format `timss03_data` is a [tibble][tibble::tibble-package] containing TIMSS
...
#'   \url{https://education.uiowa.edu/sites/education.uiowa.edu/files/2022-10/casma-research-report-35.pdf}
#' @rdname timss03
#' @aliases timss03
"timss03_data"

#' @format `timss03_qmatrix` is a [tibble][tibble::tibble-package] that
